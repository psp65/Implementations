 ...
 *
 * @author rbk Version 1.1: Updated constructor of GraphAlgorithm and its Graph
 * g to be public (2018/10/24). Ver 1.2: Made Edge implement Comparable<Edge>
 * based on edge weight, added methods getVertexArray() and getEdgeArray() to
 * Graph class (2018/11/06). Do not modify this file.
 */
package rbk;
...
public class Graph implements Iterable<Graph.Vertex> {
    ...
    public class Edge implements Comparable<Edge> {
        ...
        /**
         * To use hashing with Edge as key, you need to ensure that name is
         * unique
         */
        public int hashCode() {
            return name;
    ...
    /**
     * Method to return the outgoing edges of a directed graph as an iterable
     * object
     */
    ...
    /**
     * Method to return the incoming edges of a directed graph as an iterable
     * object
     */
    ...
    /**
     * Class to store properties of vertices in a class V that implements
     * Factory. A parallel array is created to store properties of all vertices.
    ...
    /**
     * Class to facilitate writing graph algorithms, where a generic class V is
     * used to store attributes of vertices during the algorithm.
     */
    public static class GraphAlgorithm<V extends Factory> {
        ...
        /**
         * @param: a graph g and a sample node vf used to create additional
         * nodes using the Factory interface
         */
